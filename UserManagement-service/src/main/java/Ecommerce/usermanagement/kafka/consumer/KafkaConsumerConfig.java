...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UserLoginEvent> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "Ecommerce.usermanagement.kafka.events");
        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "Ecommerce.usermanagement.kafka.events.UserLoginEvent");
